class LobbySettings{
    ...
    setAnsweringType = (answeringType) => {
        assertInDictionary(answeringType, CONST_VALUES.ANSWERING, "CONST_VALUES.ANSWERING")
        this.settings.answeringType = answeringType
    }

    setAnsweringTypeTyping = () => {
        this.setAnsweringType(CONST_VALUES.ANSWERING.TYPING)
    }

    setAnsweringTypeMix = () => {
        this.setAnsweringType(CONST_VALUES.ANSWERING.MIX)
    }

    setAnsweringTypeMultipleChoice = () => {
        this.setAnsweringType(CONST_VALUES.ANSWERING.MULTIPLE_CHOICE)
    }
