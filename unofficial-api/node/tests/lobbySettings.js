...
test = (verbose=verboseTests) => {
    ...
    verifyFailList(dummy.enableRebroadcastSongs, 1, 0, "", undefined)
    verifyFailList(dummy.enableDubSongs, 1, 0, "", undefined)
    verifyFailList(dummy.enablefullSongRange, 1, 0, "", undefined)
    ...
    verifyFailList(dummy.enableOpeningCategories, [false, false, false, false], [1, true, true, true], [true, 1, true, true], [true, true, 1, true], [true, true, 1, true])
    verifyFailList(dummy.enableEndingCategories, [false, false, false, false], [1, true, true, true], [true, 1, true, true], [true, true, 1, true], [true, true, 1, true])
    verifyFailList(dummy.enableInsertCategories, [false, false, false, false], [1, true, true, true], [true, 1, true, true], [true, true, 1, true], [true, true, 1, true])
    verifyFailList(dummy.enableInsertCategories, [false, false, false, false], [1, true, true, true], [true, 1, true, true], [true, true, 1, true], [true, true, 1, true])
    ...
    verifyFailList(dummy.setExtraGuessTime, "4", CONST_VALUES.EXTRA_GUESS_TIME_MIN-1, CONST_VALUES.EXTRA_GUESS_TIME_MAX+1,10.5)
    verifyFailList(dummy.setExtraGuessTimeAdvanced, [CONST_VALUES.EXTRA_GUESS_TIME_MIN,"4"], ["4",CONST_VALUES.EXTRA_GUESS_TIME_MAX], [CONST_VALUES.EXTRA_GUESS_TIME_MIN-1, CONST_VALUES.EXTRA_GUESS_TIME_MAX],[CONST_VALUES.EXTRA_GUESS_TIME_MIN, CONST_VALUES.EXTRA_GUESS_TIME_MAX+1], [CONST_VALUES.EXTRA_GUESS_TIME_MAX, CONST_VALUES.EXTRA_GUESS_TIME_MIN])
    verifyFailList(dummy.enableRandomGuessTime, 1, 0, "", undefined)
    verifyFailList(dummy.setScoreType, 0, 5, "a", undefined)
    verifyFailList(dummy.setAnsweringMode, 0, 4, "a", undefined)
    ...
    verifyFailList(dummy.setBossLives, "4", CONST_VALUES.BOSS_LIVES_MIN-1, CONST_VALUES.BOSS_LIVES_MAX+1,4.5)
    verifyFailList(dummy.setBossPowerUps, "4", CONST_VALUES.BOSS_POWER_UPS_MIN-1, CONST_VALUES.BOSS_POWER_UPS_MAX+1,4.5)
    verifyFailList(dummy.setBossMaxSongs, "4", CONST_VALUES.BOSS_MAX_SONGS_MIN-1, CONST_VALUES.BOSS_MAX_SONGS_MAX+1,4.5)
